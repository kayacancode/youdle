...
def run_generation(
    ...
    Args:
        ...
        use_placeholder_images: Use placeholder images
        batch_size: Number of articles to search
        search_days_back: How far back to search
        use_langgraph: Use LangGraph workflow (default: True)
...
if __name__ == "__main__":
    ...
    # Print result (excluding full state for readability if using LangGraph)
